 ...
 */
public class CosmicMoneySQLiteOpenHelper extends SQLiteOpenHelper {

    private static final String TAG = CosmicMoneySQLiteOpenHelper.class.getSimpleName();

    private static final int database_version = 19;
    private static final String database_name = "ILOVEMONEY";
    ...
    private static CosmicMoneySQLiteOpenHelper instance;

    private CosmicMoneyServerSyncHelper serverSyncHelper;
    private Context context;

    private CosmicMoneySQLiteOpenHelper(Context context) {
        super(context, database_name, null, database_version);
        this.context = context.getApplicationContext();
        serverSyncHelper = CosmicMoneyServerSyncHelper.getInstance(this);
        //recreateDatabase(getWritableDatabase());
    }

    public static CosmicMoneySQLiteOpenHelper getInstance(Context context) {
        if (instance == null) {
            return instance = new CosmicMoneySQLiteOpenHelper(context.getApplicationContext());
        } else {
            return instance;
        }
    }

    public CosmicMoneyServerSyncHelper getCosmicMoneyServerSyncHelper() {
        ...
        if (oldVersion < 4) {
            ...
            for (DBProject project : projects) {
                ...
                if (url == null) {
                    ...
                    project.setType(ProjectType.ILOVEMONEY);
                }
