...
import static net.bobotig.cosmicmoney.util.SupportUtil.SETTLE_OPTIMAL;
import static net.bobotig.cosmicmoney.util.SupportUtil.settleBills;
...
public class ProjectSettlementDialogBuilder {
    ...
    public AlertDialog show() {
        ...
        List<DBMember> membersSortedByName = db.getMembersOfProject(proj.getId(), CosmicMoneySQLiteOpenHelper.key_name);
    ...
    private void updateSettlement(
        ...
        List<DBMember> membersSortedByName = db.getMembersOfProject(projectId, CosmicMoneySQLiteOpenHelper.key_name);
