...
import net.bobotig.cosmicmoney.android.ui.UserAdapter;
import net.bobotig.cosmicmoney.android.ui.UserItem;
import net.bobotig.cosmicmoney.databinding.FragmentEditBillBinding;
...
import net.bobotig.cosmicmoney.model.parsed.AustrianBillQrCode;
import net.bobotig.cosmicmoney.model.parsed.CroatianBillQrCode;
...
import net.bobotig.cosmicmoney.util.BillParser;
...
public class EditBillFragment extends ThemedFragment {
    ...
    private CosmicMoneySQLiteOpenHelper db;
    ...
    protected long saveBill(@Nullable ICallback callback) {
        ...
        if (bill.getId() != 0) {
            ...
            // db.getCosmicMoneyServerSyncHelper().scheduleSync(true, bill.getProjectId());
            return newBillId;
        }
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        // see https://gitlab.com/eneiluj/cosmicmoney/-/issues/126
        if (bill.getId() == 0 && "".equals(bill.getWhat())) {
        ...
        if (!ProjectType.ILOVEMONEY.equals(projectType)) {
