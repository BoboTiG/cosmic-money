            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        if (!db.getCosmicMoneyServerSyncHelper().deleteRemoteProject(project.getId(), deleteCallBack)) {
        ...
        switch (item.getItemId()) {
            ...
            /*case R.id.menu_save:
                if (!SupportUtil.isValidEmail(getEmail())) {
                    ...
                    //saveProject(null);
                    db.getCosmicMoneyServerSyncHelper().editRemoteProject(project.getId(), getName(), getEmail(), getPassword(), editCallBack);
                }
                return true;*/
            default:
