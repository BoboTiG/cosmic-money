...
import net.bobotig.cosmicmoney.android.fragment.LoginDialogFragment;
import net.bobotig.cosmicmoney.databinding.ActivityAccountBinding;
...
//                getSupportActionBar().setDisplayHomeAsUpEnabled(false);
        ...
        use_sso_switch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isChecked) {
                    ...
                    // empty account list
                    CosmicMoneySQLiteOpenHelper db = CosmicMoneySQLiteOpenHelper.getInstance(view.getContext());
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                ...
                try {
                    ...
                    CosmicMoneyServerSyncHelper.getInstance(CosmicMoneySQLiteOpenHelper.getInstance(getApplicationContext()))
                            .checkCertificate(cert.getEncoded(), new IOnCertificateDecision.Stub() {
                                @Override
                                public void accept() {
                                    Log.d("CosmicMoney", "cert accepted");
                                    handler.proceed();
                                    accepted[0] = true;
                                }
                                ...
                                @Override
                                public void reject() {
                                    Log.d("CosmicMoney", "cert rejected");
                                    handler.cancel();
                                }
                            });
                    ...
                    if (!accepted[0]) {
                        ...
                        Log.e("CosmicMoney", "No response from certificate service");
                        handler.cancel();
                    }
                } catch (Exception e) {
                    Log.e("CosmicMoney", "Cert could not be verified");
                    handler.cancel();
                }
            }
    ...
    private class URLValidatorAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            CustomCertManager ccm = CosmicMoneyServerSyncHelper.getInstance(CosmicMoneySQLiteOpenHelper.getInstance(getApplicationContext())).getCustomCertManager();
    ...
    private class LoginValidatorAsyncTask extends AsyncTask<String, Void, LoginStatus> {
        ...
        protected void onPostExecute(LoginStatus status) {
            if (LoginStatus.OK.equals(status)) {
                ...
                Log.e("CosmicMoney", "invalid login");
